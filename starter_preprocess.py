...
class TextPreprocessor:
    ...
    def fetch_from_url(self, url: str) -> str:
        ...
        if not url.lower().endswith('.txt'):
            raise ValueError('URL must link to a .txt file')
        ...
        try:
            ...
            raise Exception(f"Could not fetch file from URL: {str(e)}")
    ...
    def get_text_statistics(self, text: str) -> Dict:
        ...
        Returns dictionary with:
            ...
            avg_word_length, avg_sentence_length, most_common_words (top 10)
        """
        ...
        if total_sentences > 0:
            total_words_in_sentences = sum(
                len(self.tokenize_words(s)) for s in sentences)
    ...
    def create_summary(self, text: str, num_sentences: int = 3) -> str:
        ...
        # Take first num_sentences sentences
...
if __name__ == "__main__":
    ...
    # Test summary
    summary = preprocessor.create_summary(clean_text, 2)
